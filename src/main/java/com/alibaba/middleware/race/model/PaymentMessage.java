...
/**
 * 我们后台RocketMq存储的交易消息模型类似于PaymentMessage，选手也可以自定义 订单消息模型，只要模型中各个字段的类型和顺序和PaymentMessage一样，即可用Kryo 反序列出消息
 */
...
public class PaymentMessage implements Serializable
{
    ...
    /**
     * Money来源 0,支付宝 1,红包或代金券 2,银联 3,其他
     */
    ...
    {
        return "PaymentMessage{" + "orderId=" + orderId + ", payAmount=" + payAmount + ", paySource=" + paySource
